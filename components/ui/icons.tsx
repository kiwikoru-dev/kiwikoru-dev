...
/* ── Nav-section glyphs (navbar collapsed icon rail) ────────────────────────
   Lucide-shaped, matching the sky-mode set: 24×24, currentColor stroke, 1.75
   width, round caps/joins so they read cleanly at ~20px. One per nav link. */
