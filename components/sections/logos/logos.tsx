...
// ⚠️ PLACEHOLDER: KiwiKoru has published no client list, and inventing one would
// be a false claim of custom. These are the AWS SERVICES the practice works
// across — true, verifiable, and they fill the marquee honestly. Swap for real
// client wordmarks once logo permission is in hand, and change the caption
// below back to a "trusted by" line at the same time.
const BRANDS = [
  "EC2",
  "S3",
  "RDS",
